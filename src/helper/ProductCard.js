...
function ProductCard(props) {
  ...
  return (
      ...
      <div className="col-lg-3 col-md-4 col-sm-6 mb-2">
        <div className="card">
        <img src={props.thumbnail} width={200} height={250} alt="no img" className='card-img-top' />
            ...
            <div className="card-footer">
              <NavLink to={`/product/${props.id}/category/:${props.category}`}>
                <i className='bi bi-info-circle-fill'></i>
              </NavLink>
              <button onClick={()=>addToCart(props)} className="btn btn-outline-success btn-sm float-end"><i className='bi bi-cart'></i></button>
            </div>
        </div>
      </div>
